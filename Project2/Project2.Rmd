...
## http://onlinelibrary.wiley.com/doi/10.1002/9781118950951.ch12/pdf
...
unkcenter.2 <- flexclust::kcca(firsttwo, k=2,save.data = T)

#plot(firsttwo)
image(unkcenter.2)
points(firsttwo)

data.frame(unkcenter.2)
#unkcenter.2[xrange]

#flexclust::pairs-methods(unkcenter.2)
##barplot(unkcenter.2)
ttt = flexclust::kcca2df(unkcenter.2)
ttt1=ttt[c(1:210),]
ttt2=ttt[c(211:420),]
ttt3=cbind(ttt1,ttt2)
ttt=ttt3[,c(1,4,6)]

ggplot(ttt, aes(value, value.1, color = factor(ttt$group))) + geom_point()
