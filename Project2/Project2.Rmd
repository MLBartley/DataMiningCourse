...
In this section, supervised K-nearest clustering is applied in the original dataset. The true and predictied lables in training and test data are shown in the figures below. In general, in the training data, we obtained the accuracy rate of 92.9% and in the testing data, the accuarcy rate is about 90.5%. 
...
par(mfrow=c(1,2))
ggplot(p2d_train, aes(area, perimeter, color = factor(p2d_trainlabels))) + geom_point() +theme(legend.title = element_blank()) + ggtitle("True labels in Training data") 
ggplot(p2d_train, aes(area, perimeter, color = factor(knn_train))) + geom_point() +theme(legend.title = element_blank()) + ggtitle("Kmeans Prediction labels in Training data") 
...
par(mfrow=c(1,2))
ggplot(p2d_test, aes(area, perimeter, color = factor(p2d_testlabels))) + geom_point() +theme(legend.title = element_blank()) + ggtitle("True labels in Test data") 
ggplot(p2d_test, aes(area, perimeter, color = factor(knn_test))) + geom_point() +theme(legend.title = element_blank()) + ggtitle("Kmeans Prediction labels in Test data") 
```
